...
<html>
<head>
    <title>Staff Login - E-Voting System</title>
 ...
 <div class="container"> 
    <div class="row ">
        <div class="col-md-5 mx-auto" id="login-form" style="margin-top: 65px;">
            ...
            <h4>Staff Login</h4>
            <form action="<?php echo base_url(); ?>manage/login/auth" class="form" role="form" autocomplete="off" id="formLogin" novalidate="" method="POST">
